...
| UCE Mandate | Core Obligation | Criminal Justice Application |
|---|---|---|
| **I. Universal Protection** | Prevent irreversible degradation of persons | Prohibition of torture, inhumane conditions, and systemic dehumanization in custody |
| **II. Agency and Autonomy** | Respect and enable self-determination | Due process; right to adequate defense; protection from coercive interrogation; reentry as restored citizenship |
| **III. Integrity and Reciprocity** | Honesty, fairness, and mutual accountability | Truth-seeking prosecution; equal protection regardless of wealth or race; proportional sentencing |
| **IV. Systemic Stewardship** | Maintain the health of systems on which people depend | Preventing recidivism through structural rehabilitation; protecting the community; maintaining rule of law |
| **V. Sustained Ethical Function** | Act rightly independent of pressure or personal cost | Judicial independence; prosecutorial ethics under political pressure; correctional conduct without cruelty |
| **VI. Just Subversion** | Dismantle systems that have become actively predatory | Duty to expose wrongful conviction, racial bias, systemic corruption, and the weaponization of the legal system |
...
- Mandatory disclosure of all exculpatory evidence, with genuine penalties for suppression — not merely case dismissal but professional and criminal accountability for the prosecutor
- Public defense adequately funded to a standard that produces genuine adversarial representation, not nominal compliance with the right to counsel
- Conviction integrity units with genuine independence, empowered to review prior convictions where evidence of wrongful prosecution exists
- Prosecutorial decisions tracked and audited for racial, economic, and geographic disparities — pattern disparities treated as systemic failures requiring structural remedy, not individual aberrations
- Judicial recusal requirements enforced genuinely, with particular attention to cases involving political figures, donors, or institutions with relationships to the court
...
- Sentencing guidelines that require individualized judicial assessment of the Maimonidean factors — harm magnitude, frequency, temptation, concealment — rather than mandatory minimums that eliminate discretion
- Mandatory sentencing disparity audits: when statistical analysis reveals racial or economic disparities in sentencing for comparable offenses, structural remedy is required
- Elimination of sentences that serve no rehabilitative or protective function — extended incarceration for nonviolent offenses whose sentence length exceeds any plausible deterrent or protective rationale
- Victim impact processes that provide genuine voice without becoming instruments of revenge — the victim's suffering is morally relevant; it does not determine sentence length
- Post-sentence review mechanisms for cases where new evidence, changed circumstances, or demonstrated rehabilitation warrants reconsideration
...
- Absolute prohibition on torture, including waterboarding, prolonged solitary confinement, stress positions, sleep deprivation, and any practice that meets the legal definition of cruel and unusual punishment — enforced with criminal accountability, not administrative review
- Solitary confinement restricted to genuine emergency protective use, with strict time limits, mental health monitoring, and independent oversight — not deployed as routine management or punishment
- Physical conditions maintained at a standard that does not constitute punishment beyond the restriction of liberty: adequate food, medical care, mental health services, and sanitation
- Prohibition on prison labor that constitutes exploitation rather than rehabilitation — labor programs structured around skill development and genuine compensation, not state or corporate profit from captive workers
- Independent oversight with genuine access and authority: the institution that investigates its own abuses produces no accountability
...
- Education and vocational programming available to all incarcerated persons, not as privilege conditioned on behavior compliance but as a structural obligation of the institution
- Family connection infrastructure: transportation subsidies, unrestricted correspondence, regular contact visits, and video communication — access treated as a right, not a reward
- Reentry planning that begins at sentencing, not at release: housing, employment, healthcare, and documentation arranged before the person leaves custody
- Automatic restoration of civil rights upon completion of sentence, including voting rights and eligibility for public housing and employment — collateral consequences that extend punishment beyond the sentence are a breach of the reciprocity mandate
- Prohibition on denying professional licenses based solely on conviction history where the offense is not directly relevant to the licensed activity
- Community-based restorative justice alternatives for eligible offenses: victim-centered processes that address harm directly, rebuild relationship, and avoid the relational destruction of incarceration where public safety permits
...
Capital punishment is not categorically prohibited by the Universal Core of Ethics. The framework permits lethal force in defense of the innocent when threat is immediate, verified, and no lesser intervention is sufficient. A criminal justice system operating with full integrity could, in theory, meet that standard in extreme cases. But integrity of process is not optional. It is the precondition.

The UCE position is conditional — and the condition has not been met.
...
- Moratorium on executions until the system can demonstrate evidentiary standards, legal representation, and bias-free administration meeting the verification requirement for irreversible action
- Independent review of all cases on death row using current forensic standards and evidence not available at original trial
- Categorical prohibition on execution of persons with intellectual disabilities, severe mental illness, or offenses committed as juveniles — the diagnosis of irreducible threat cannot be made reliably in these populations
- When and if executions resume after demonstrated systemic reform: unanimous jury requirement, mandatory independent forensic review, no execution where any reasonable doubt about guilt or mental capacity exists
- Proportional accountability for wrongful execution: the state that takes an innocent life through capital punishment has committed the gravest possible Mandate I violation and must be held accountable accordingly
...
**Triage accurately:** courts that seek truth rather than victory, that apply equal protection to the wealthy and the poor, the politically connected and the invisible.

**Prescribe the correct boundary:** sentencing that is proportional, individualized, and oriented toward protection rather than vengeance.

**Do no unnecessary harm:** incarceration that restricts liberty without destroying humanity, that holds the person in trust rather than consuming them.

**Relentlessly work to cure:** rehabilitation and reentry that treats recidivism as a structural failure, that honors the Ubuntu debt, that restores citizenship fully when the sentence is complete.
